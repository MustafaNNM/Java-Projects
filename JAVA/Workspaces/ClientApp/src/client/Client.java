 ...
 *
 */
//static deðiþken belleði boþaltmaz static kullanma nesne oluþturmamýþ olabilirsin.
public class Client implements Runnable {
	...
	private OutputStream soketoutputstream = null;
	private Thread thread_single_messagewriter = null;
	...
	private void create_thread_SocketWriter() {
		...
		try {
			...
			thread_SocketWriter = new Thread(socketwriter);
		} catch (NullPointerException e) {
			ChatRoomMemberApplet.GelenKutusu.append("\nNullPointerException");
			System.out.println("NullPointerException");
			e.printStackTrace();
	 ...
	 * 
	 */
	private void create_socketwriter() {
		socketwriter = new SocketWriter(outputstream);
	}

	/**
	 * @throws IOException
	 */
	private void create_outputstream() throws IOException {
	 ...
	 * 
	 */
	private void create_inputstream() {
		if (s != null) {
			if (!s.isClosed()) {
				try {
	 ...
	 * 
	 */
	private void socket_listener() {
		socket_listener = new SocketListener(inputstream);
	}
	...
	private void create_thread_SocketListener() {
		...
		// lazým
		thread_SocketListener = new Thread(socket_listener);
	}
	...
	/**
	 * @return the socket_listener
	 */
	public static SocketListener getSocket_listener() {
		return socket_listener;
	}

	/**
	 * @param socket_listener
	 *            the socket_listener to set
	 */
	public static void setSocket_listener(SocketListener socket_listener) {
		Client.socket_listener = socket_listener;
	}
