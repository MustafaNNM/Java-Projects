...
public class Bitki {
	private String adý = "asd";
	private String latince_adý = "";
	private String diskteki_yeri = "";
	private String diskteki_adý = "";
	private int miktarý;// paket cinsinden
	private float fiyatý=0;
	...
	public Bitki(String adý, String kategori, String latince_adý,
		...
		setDiskteki_yeri(diskteki_yeri);
		setDiskteki_adý(diskteki_adý);
		degiskenler_icin_hafizadan_alan_ayirt();
		ozellikleri_ekle(özellikleri);
	}

	/**
	 * 
	 */
	private void degiskenler_icin_hafizadan_alan_ayirt() {
	 ...
	 * @param özellikleri
	 */
	private void ozellikleri_ekle(String özellikleri) {
	...
	private String kategorisi() {
		...
		return kategoride_bulunamadi();
	}

	/**
	 * @return
	 */
	private String kategoride_bulunamadi() {
		StringBuilder stringBuilder = new StringBuilder();
		stringBuilder.append("Kategorilenmemiþ\n");
		stringBuilder.append("Eðer böyle bir ürün bitki veri tabanýnda bulunuyorsa\n");
		stringBuilder.append("1)Varsa lütfen kategori.txt dosyasýndaki hatayý düzeltin\n");
		stringBuilder.append("2)Bitki veri tabanýna veri yanlýþ girilmiþ olabilir\n");
		stringBuilder.append("3)Varsa lütfen bitki.txt dosyasýndaki hatayý düzeltin\n");
		return stringBuilder.toString();
	}
