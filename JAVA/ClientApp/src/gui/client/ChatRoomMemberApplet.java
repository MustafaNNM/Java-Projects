...
public class ChatRoomMemberApplet extends JApplet {
	...
	public static void main(String[] args) {
        ...
        ChatRoomMemberApplet ChatRoomMemberApplet=new ChatRoomMemberApplet();
        window.setContentPane(ChatRoomMemberApplet.getContentPane());
