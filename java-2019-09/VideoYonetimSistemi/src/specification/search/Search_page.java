...
public class Search_page extends Page{
	...
	public Search_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/search/SearchBinding/EndSearch\">EndSearch</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/FindEvents\">FindEvents</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/FindMetadata\">FindMetadata</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/FindPTZPosition\">FindPTZPosition</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/FindRecordings\">FindRecordings</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetEventSearchResults\">GetEventSearchResults</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetMediaAttributes\">GetMediaAttributes</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetMetadataSearchResults\">GetMetadataSearchResults</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetPTZPositionSearchResults\">GetPTZPositionSearchResults</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetRecordingInformation\">GetRecordingInformation</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetRecordingSearchResults\">GetRecordingSearchResults</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetRecordingSummary\">GetRecordingSummary</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetSearchState\">GetSearchState</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/search/SearchBinding/GetServiceCapabilities\">GetServiceCapabilities</a>\r\n<br>";
	}

	public void load(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Search_page loading");
		/* request uri starts with Environment.search_page.getURI() */
		if (target != null) {
			if (target.equals("")) {
				/* request uri equals Environment.search_page.getURI() */
				...
				if (target.startsWith(Environment.searchbinding_page.getURI())) {
					load_SearchBinding_page(target, baseRequest, request, response);
				} else {
					/* there is no other binding in search */
	...
	private void load_SearchBinding_page(String target, Request baseRequest, HttpServletRequest request,
