...
public class Dot1XBinding_page extends Page {
	...
	public Dot1XBinding_page(String target) {
		super(target);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/advancedsecurity/Dot1XBinding/AddDot1XConfiguration\">AddDot1XConfiguration</a>\r\n<br>"
