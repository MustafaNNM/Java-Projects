...
public class TLSServerBinding_page extends Page{
	...
	public TLSServerBinding_page(String target) {
		super(target);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/advancedsecurity/TLSServerBinding/AddCertPathValidationPolicyAssignment\">AddCertPathValidationPolicyAssignment</a>\r\n<br>"
