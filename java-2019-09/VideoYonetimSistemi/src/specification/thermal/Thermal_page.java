 ...
 *
 */
public class Thermal_page extends Page{
	...
	public Thermal_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/thermal/ThermalBinding/EndSearch\">EndSearch</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/FindEvents\">FindEvents</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/FindMetadata\">FindMetadata</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/FindPTZPosition\">FindPTZPosition</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/FindRecordings\">FindRecordings</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/GetEventSearchResults\">GetEventSearchResults</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/GetMediaAttributes\">GetMediaAttributes</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/thermal/ThermalBinding/GetMetadataSearchResults\">GetMetadataSearchResults</a>\r\n<br>";
	}

	public void load(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Thermal_page loading");
		/* request uri starts with Environment.thermal_page.getURI() */
		if (target != null) {
			if (target.equals("")) {
				/* request uri equals Environment.thermal_page.getURI() */
				...
				if (target.startsWith(Environment.thermalbinding_page.getURI())) {
					load_ThermalBinding_page(target, baseRequest, request, response);
				} else {
					/* there is no other binding in thermal */
	...
	private void load_ThermalBinding_page(String target, Request baseRequest, HttpServletRequest request,
