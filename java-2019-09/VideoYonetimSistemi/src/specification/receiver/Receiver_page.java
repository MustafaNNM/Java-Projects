 ...
 *
 */
public class Receiver_page extends Page{
	...
	public Receiver_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/receiver/ReceiverBinding/ConfigureReceiver\">ConfigureReceiver</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/CreateReceiver\">CreateReceiver</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/DeleteReceiver\">DeleteReceiver</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/GetReceiver\">GetReceiver</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/GetReceivers\">GetReceivers</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/GetReceiverState\">GetReceiverState</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/GetServiceCapabilities\">GetServiceCapabilities</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/receiver/ReceiverBinding/SetReceiverMode\">SetReceiverMode</a>\r\n<br>";
	}

	public void load(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Receiver_page loading");
		/* request uri starts with Environment.receiver_page.getURI() */
		if (target != null) {
			if (target.equals("")) {
				/* request uri equals Environment.receiver_page.getURI() */
				...
				if (target.startsWith(Environment.receiverbinding_page.getURI())) {
					load_ReceiverBinding_page(target, baseRequest, request, response);
				} else {
					/* there is no other binding in receiver */
	...
	private void load_ReceiverBinding_page(String target, Request baseRequest, HttpServletRequest request,
