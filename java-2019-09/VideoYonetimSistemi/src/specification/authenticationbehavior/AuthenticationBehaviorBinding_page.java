...
public class AuthenticationBehaviorBinding_page  extends Page{
	...
	public AuthenticationBehaviorBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		setRequestler("<a href=\"http://localhost:8080/authenticationbehavior/AuthenticationBehaviorBinding/CreateAuthenticationProfile\">CreateAuthenticationProfile</a>\r\n<br>"
