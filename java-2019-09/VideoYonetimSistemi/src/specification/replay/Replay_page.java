 ...
 *
 */
public class Replay_page extends Page{
	...
	public Replay_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/replay/ReplayBinding/CreateRecording\">CreateRecording</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/replay/ReplayBinding/CreateRecordingJob\">CreateRecordingJob</a>\r\n<br>"
				+ "<a href=\"http://localhost:8080/replay/ReplayBinding/CreateTrack\">CreateTrack</a>\r\nv"
				+ "<a href=\"http://localhost:8080/replay/ReplayBinding/DeleteRecording\">DeleteRecording</a>\r\n<br>";
	}

	public void load(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Replay_page loading");
		/* request uri starts with Environment.replay_page.getURI() */
		if (target != null) {
			if (target.equals("")) {
				/* request uri equals Environment.replay_page.getURI() */
				...
				if (target.startsWith(Environment.replaybinding_page.getURI())) {
					load_ReplayBinding_page(target, baseRequest, request, response);
				} else {
					/* there is no other binding in replay */
	...
	private void load_ReplayBinding_page(String target, Request baseRequest, HttpServletRequest request,
