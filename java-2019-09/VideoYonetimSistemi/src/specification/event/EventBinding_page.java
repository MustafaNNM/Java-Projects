...
public class EventBinding_page extends Page{
	...
	public EventBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/event/EventBinding/CreatePullPointSubscription\">CreatePullPointSubscription</a>\r\n<br>"
