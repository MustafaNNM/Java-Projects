...
public class NotificationConsumerBinding_page extends Page{
	...
	public NotificationConsumerBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler ="<a href=\"http://localhost:8080/event/NotificationConsumerBinding/Notify\">Notify</a>\r\n<br>";
		subrequestURI = "";
	}
