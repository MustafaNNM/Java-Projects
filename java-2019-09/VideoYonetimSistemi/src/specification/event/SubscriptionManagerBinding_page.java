...
public class SubscriptionManagerBinding_page extends Page{
	...
	public SubscriptionManagerBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler ="<a href=\"http://localhost:8080/event/SubscriptionManagerBinding/Renew\">Renew</a>\r\n<br>"
