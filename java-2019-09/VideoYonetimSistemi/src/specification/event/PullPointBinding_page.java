...
public class PullPointBinding_page extends Page{
	...
	public PullPointBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/event/PullPointBinding/DestroyPullPoint\">DestroyPullPoint</a>\r\n<br>"
