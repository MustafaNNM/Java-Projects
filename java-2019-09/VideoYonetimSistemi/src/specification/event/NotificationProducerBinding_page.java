 ...
 *
 */
public class NotificationProducerBinding_page extends Page {
	...
	public NotificationProducerBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/event/NotificationProducerBinding/GetCurrentMessage\">GetCurrentMessage</a>\r\n<br>"
