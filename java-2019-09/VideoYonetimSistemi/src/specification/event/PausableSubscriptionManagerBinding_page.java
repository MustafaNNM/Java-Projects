...
public class PausableSubscriptionManagerBinding_page extends Page{
	...
	public PausableSubscriptionManagerBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/event/PausableSubscriptionManagerBinding/PauseSubscription\">PauseSubscription</a>\r\n<br>"
