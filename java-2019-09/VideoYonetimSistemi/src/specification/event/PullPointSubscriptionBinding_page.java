...
public class PullPointSubscriptionBinding_page extends Page{
	...
	public PullPointSubscriptionBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler = "<a href=\"http://localhost:8080/event/PullPointSubscriptionBinding/PullMessages\">PullMessages</a>\r\n<br>"
