 ...
 *
 */
public class Schedule_page extends Page{
	...
	public Schedule_page(String string) {
		super(string);
		requestURI = "";
	...
	public void load(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) {
		System.out.println("Schedule_page loading");
		/* request uri starts with Environment.schedule_page.getURI() */
		if (target != null) {
			if (target.equals("")) {
				/* request uri equals Environment.schedule_page.getURI() */
				...
				if (target.startsWith(Environment.schedulebinding_page.getURI())) {
					load_ScheduleBinding_page(target, baseRequest, request, response);
				} else {
					/* there is no other binding in schedule */
	...
	private void load_ScheduleBinding_page(String target, Request baseRequest, HttpServletRequest request,
