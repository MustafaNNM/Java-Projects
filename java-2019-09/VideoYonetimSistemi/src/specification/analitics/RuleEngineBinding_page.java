...
public class RuleEngineBinding_page  extends Page{
	...
	public RuleEngineBinding_page(String string) {
		super(string);
		requestURI = "";
		...
		requestler ="<a href=\"http://localhost:8080/analytics/RuleEngineBinding/CreateRules\">CreateRules</a>\r\n<br>"
