...
#include "tarih.h"
  ...
  {setpersonel(fname,lname,nick,m_k);sonraki=NULL;}
  //set functions
  ...
  void Personel::sonrakiayarla(Personel *arg){sonraki=arg;}
  void Personel::sonrakiayarla(Personel *arg){sonraki_tarih=arg;}
  void Personel::sonrakiayarla(Personel *arg){onceki_tarih=arg;}
  //get functions
  ...
  Personel *Personel::sonrakioku()
  {
    return sonraki;
  }
  Personel *Personel::sonraki_tarih_oku()
  {
    return sonraki_tarih;
  }
  Personel *Personel::onceki_tarih_oku()
  {
    return onceki_tarih;
  }
