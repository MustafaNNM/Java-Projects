...
void birinci_sinif_not_hesabi()
{
    ...
    char *ders1[9]={"Turk Dili","Fizik","Ogretim Ilke ve Yontemleri","Beden Egitimi","Muzik","Cevre Egitimi","Felsefe","Fen ve Teknoloji","Sosyoloji"};
    char *ders2[7]={"Algoritma II","Matematik II","Fizik II","Ayrik Yapilar","BBG","Edebiyat II","Tarih II"};
    float katsayi1[9]={2,2,3,2,2,2,2,1,2};
